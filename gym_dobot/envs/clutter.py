...
class DobotClutterPickEnv(clutter_env.DobotClutterEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse',clutter_num=10):
        initial_qpos = {
            'dobot:slide0': 0.8,
            'dobot:slide1': 1.2,
            'dobot:slide2': -0.04,
        ...
        clutter_env.DobotClutterEnv.__init__(
            self, 'dobot/clutter_pick.xml', has_object=True, block_gripper=False, n_substeps=20,
